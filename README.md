...
- **1.8.3** — Licensing clarified: tokstat is MIT, with `src/tokstat/_ecologits.py` under MPL-2.0 (it ports EcoLogits' formula + constants). Package metadata is `MIT AND MPL-2.0`; see `NOTICE`.
